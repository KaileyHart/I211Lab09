...
class Register extends View
{
    public function display() {
        ...
        <div class="middle-row">
            ...
            <form action="index.php?action=verify" method="post" style="display: flex; flex-direction: column" >
                ...
                <button action="login" style="background-color: #000; color: #fff; padding: 12px; border: none;">Register</button>
            </form>
