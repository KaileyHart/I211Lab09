...
class Login extends View
{
    ...
    <div class="middle-row">
        ...
        <form action="index.php?action=index" method="post" style="display: flex; flex-direction: column" >
            ...
            <input style="background-color: #000; color: #fff; padding: 12px; border: none;" type="submit" action="index.php?action=index" value="LOGIN">
        </form>
